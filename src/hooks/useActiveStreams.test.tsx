...
describe('useActiveStreams', () => {
    ...
    it('should return all active streams', () => {
        ...
        queryClient.setQueryData(StreamingKeys.messages.stream('msg_456'), {
            messageId: 'msg_456',
            threadId: 'thread_456',
            content: 'Content 2',
            isStreaming: true,
        ...
        queryClient.setQueryData(StreamingKeys.threads.stream('thread_789'), {
            messageId: 'msg_789',
            threadId: 'thread_789',
            content: 'Content 3',
            isStreaming: true,
    ...
    it('should include query keys in returned streams', () => {
        ...
        queryClient.setQueryData(modelKey, {
            messageId: 'msg_123',
            threadId: 'thread_123',
            content: 'Content 1',
            isStreaming: true,
