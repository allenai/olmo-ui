...
export const newMessageWithSystemMessageId = 'msg_overrideSystemPrompt';
const MockSystemPrompt = 'Mock system prompt';
export const streamResponseWithSystemPromptOverrideResponse: Array<Thread | MessageChunk> = [
    {
        id: newMessageWithSystemMessageId,
        messages: [
            {
                content: MockSystemPrompt,
                snippet: MockSystemPrompt,
