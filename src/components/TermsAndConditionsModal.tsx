...
const Section1: TermsAndConditionsSection = {
    ...
    contents: (
        <>
            ...
            content, especially about minority groups. Ai2 uses several strategies to mitigate these
            behaviors for the benefit of the general public, but please note model outputs will
            still contain biases, toxic content, or harmful language. These undesirable results have
            a legitimate research purpose, however, especially for researchers investigating the
            sources of bias, toxicity, and harmful language generated by LLMs. It’s important to
            understand that while using the Dataset Explorer you may encounter documents with
            biases, harmful language or toxic content. Please be mindful of Ai2’s research and
            educational purposes and always use your best judgment when interpreting Ai2
            model-generated content. Ai2 is providing open tools like Playground and OLMo to support
            the development of tools that will make LLMs less biased, safer, and more trustworthy in
            the future.
        </>
    ),
    acknowledgement:
...
const Section2: TermsAndConditionsSection = {
    ...
    contents: (
        <>
            The Ai2 Playground is intended for research and educational purposes in accordance with our{' '}
            ...
            . The Ai2 Playground collects user queries and inputs entered into it as well as other
            information about the user. You will have 30 days to delete your queries before they
            will be stored and used for future research and educational purposes in the public
            ...
            Dataset Explorer may be shared outside of Ai2, as permitted by applicable law and Ai2’s
            policies. Please use your discretion and best judgment when accessing and using the Ai2
            Playground. NEVER submit any personal, sensitive, or confidential information in your
            use of the Ai2 Playground or Dataset Explorer.
        </>
    ),
    acknowledgement: (
        <>
