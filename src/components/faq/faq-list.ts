    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: 'To interact with the LLMs in the Playground via your voice, click the microphone icon in the chat input, grant microphone access when prompted, then simply speak your prompt.',
            },
            {
                question: 'How do I stop recording?',
                answer: 'When you’re finished speaking, click the check mark icon to see your fully transcribed query. Press the X icon to cancel audio capture.',
            },
            {
