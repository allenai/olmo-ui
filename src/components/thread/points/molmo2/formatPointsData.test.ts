...
describe('Parse Points', () => {
    ...
    it('parse single image with multiple points tags into ImagePoints', () => {
        const singleImagePointsTag = `<points alt="alt_text" coords="1 193 076 2 226 144">label_text</points> and <points alt="alt_text2" coords="1 193 076 2 226 144">label_text2</points>`;
