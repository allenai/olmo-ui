...
export const AttributionContent = () => {
    ...
    return (
        <AttributionContentStack direction="column" gap={2} data-testid="attribution-drawer">
            ...
            <Typography>CorpusLink shows documents from the training data that have exact text matches with the model response. Select a highlight to view its documents.</Typography>
            <Typography variant="body2">
                CorpusLink might retrieve documents that can be used to fact check parts of the model's response, if the response contains simple facts. However, creative generations (e.g. writing a poem) or novel generations (e.g. writing code) likely cannot be fact checked by looking at these retrieved documents.
            </Typography>
            <Typography variant="body2">
                The model did not have direct access to these documents when generating the response. Documents are retrieved after the response generation. <Link href={links.faqs + getFAQIdByShortId('corpuslink-intro')} underline="always">Learn more</Link>
            </Typography>
            <Button
                variant="contained"
