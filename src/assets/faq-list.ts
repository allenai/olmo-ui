...
export const faqs: FAQCategory[] = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                content:
                    'OLMo is built on the [AI2 Dolma dataset](https://blog.allenai.org/dolma-3-trillion-tokens-open-llm-corpus-9a0ff4b8da64), an open dataset of 3 trillion tokens from a diverse mix of web content, academic publications, code, books, and encyclopedic materials. It is generally available for download from the Hugging Face Hub and is the largest open dataset to date for LLM training. For more technical details on the model, read our [Getting Started with OLMo technical blog](https://blog.allenai.org/olmo-open-language-model-87ccfc95f580).',
            },
            {
                summary: "How up-to-date is OLMo's training data?",
                content:
                    'The [OLMo-7B-Instruct](https://huggingface.co/allenai/OLMo-7B-Instruct) model is trained on data collected up until March 2023. Its training data only includes events or publications before that date.',
            },
            {
                summary: 'How accurate and reliable is OLMo-generated content?',
                content:
                    'OLMo-generated content is built for experimental and research use only. It is not intended to be accurate or reliable, but rather as a research tool. Please use your judgment, fact-check important information, and consider the context when interpreting or using OLMo-generated content.',
            },
            {
                summary: 'Can OLMo be biased or produce inappropriate content?',
                content:
            ...
            {
                summary: 'How will AI2 mitigate harmful bias and other negative effects of OLMo?',
                content:
                    'We understand that OLMo, like other LLMs, can produce biased content and has the risk of being misused. However, we believe that by opening up our framework and data, we can empower researchers and AI practitioners to gain deeper insights into the science of LLMs, which is critical to building the next generation of safe and trustworthy AI. Instead of building the most accurate or safe LLM, we are focused on fostering research around all areas of LLM development, including safety and accuracy.',
            },
            {
                summary:
            ...
            },
            {
                ...
                content:
                    'Starting with our OLMo project, AI2 has worked to implement “Fair Use by Design” into the development process for AI artifacts. This means we identified decision points where we could modify training data to transform it in a manner that we believe would meet the criteria for the fair use exception to copyright infringement.\n\nSimply put, the overarching principle is that our AI artifacts and anything they generate should not compete with the original source material or negatively affect the value of the copyrighted work to the greatest extent reasonably possible while still remaining useful for scientific research.',
            },
            {
                summary: 'Which countries and territories have access to OLMo?',
                content:
                    'OLMo is designed to be globally accessible, subject to compliance with applicable laws. ',
            },
            {
                summary: 'Does OLMo support other languages outside of English?',
                content: 'Currently, OLMo only supports the English language. ',
            },
            {
                summary: 'How can I contact support?',
                content:
                    'If you can’t find an answer to your question on this page, you can contact support by reaching out to our Discord community [ link to be inserted when available]. Our dedicated team is ready to assist with technical issues, account inquiries, and general questions about OLMo and its framework.',
            },
        ],
    },
    {
        ...
        questions: [
            {
                ...
                content:
                    'You can create an account by signing in via your Google account. We plan to extend support to other sign-in methods in the future.',
            },
            {
                summary: 'Can I change the email address associated with my account?',
                content:
                    'No, your account is linked to your Google account. If you would like to change the email address, please sign in from a different Google account.',
            },
            {
                summary: 'How can I delete my account?',
                content:
                    'Your account is linked to your Google account. You can remove the authorization via security settings in your Google account. Please note that removing the authorization does not delete your chat history from our database.',
            },
        ],
    },
    {
        ...
        questions: [
            {
                summary: 'What data does AI2 collect about me?',
                content:
                    'We collect data necessary to improve your experience and the performance of OLMo as described in our general [Terms and Conditions of Use and Privacy Policy](https://allenai.org/terms). This includes interaction data with the model, such as queries and responses, to refine and enhance OLMo’s capabilities. ',
            },
            {
                summary: 'How is my data used to improve OLMo’s performance?',
                content:
                    'Your data helps us understand how users interact with OLMo, identify areas for improvement, and develop new features. We analyze aggregate data to inform updates and enhancements to ensure OLMo remains effective and relevant. Please see our Privacy Policy for more information.',
            },
            {
                summary: 'How can I opt out of my data being used for model improvement?',
                content:
                    'We currently do not provide a way to opt out. However, you can delete your chat history within 30 days via the deletion function in the interactions threads interface. Deleted messages will be removed from our database.',
            },
            {
                summary: 'How long does AI2 retain my chat history and personal information?',
                content:
                    'We retain chat history and personal information for a period necessary to fulfill the purposes outlined in our [Privacy Policy](https://allenai.org/privacy-policy), after which it is securely deleted.',
            },
            {
                summary: 'Is my personal data and chat history shared with third parties?',
                content:
            ...
            {
                summary: 'How can I request to delete my chat history?',
                content:
                    'You can request data deletion via the deletion function in the interactions threads interface. If you have difficulties or other concerns, contact us via our Discord community [link to be inserted when available]. We will guide you through the process and ensure your data is promptly removed in accordance with our Terms and Conditions of Use, privacy and data retention policies.',
            },
            {
                summary: 'Will AI2 claim copyright over the outputs I generate with OLMo?',
                content: 'No, we do not claim copyright over the outputs generated by OLMo.',
            },
            {
                summary:
                    "What are AI2's policies regarding sharing and publication of OLMo-generated content?",
                content:
                    'We encourage users to review our [Terms and Conditions of Use](https://allenai.org/terms) for detailed guidelines on our preferred approach to sharing and publication.',
            },
        ],
    },
] as const;
